...
export type LlmAnalysisListAnalysesData = {
    limit?: number;
    projectId: string;
    skip?: number;
};

export type LlmAnalysisListAnalysesResponse = (AnalysisListResponse);

export type LlmAnalysisGetAnalysisData = {
    analysisId: string;
    projectId: string;
};

export type LlmAnalysisGetAnalysisResponse = (AnalysisResponse);

export type LlmAnalysisDeleteAnalysisData = {
    analysisId: string;
    projectId: string;
};

export type LlmAnalysisDeleteAnalysisResponse = (unknown);
