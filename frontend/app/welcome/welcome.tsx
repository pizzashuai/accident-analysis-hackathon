...
export function Welcome() {
  return (
    <Flex
      ...
      px='md'
    >
      <Flex direction='column' gap='xl' align='center' maw={1400} w='100%'>
        <Flex component='header' direction='column' align='center' gap='lg'>
          ...
          <Title order={2}>Homography Point Picker</Title>
          <Text c='dimmed' ta='center' maw={600}>
            Upload CCTV and Bird&apos;s-eye view images, then pick corresponding
            points to create a homography transformation.
          </Text>
        </Flex>
